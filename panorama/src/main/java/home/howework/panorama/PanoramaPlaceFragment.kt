package home.howework.panorama
...
import home.howework.panorama.databinding.PanoramaPlaceFragmentBinding
...
class PanoramaPlaceFragment:Fragment(),PanoramaService.SearchListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mArgs = arguments
        var lat: Double = mArgs!!.getFloat("lat").toDouble()
        var long: Double = mArgs!!.getFloat("long").toDouble()
